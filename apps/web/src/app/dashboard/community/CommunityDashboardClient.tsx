...
import { useRolePermission, type RpUser } from "@features/user/hooks/useRolePermission";

export default function CommunityDashboardClient({
  me,
  demo = false,
}: { me: RpUser | null; demo?: boolean }) {
  // Optional: Client-seitiger Soft-Gate (Server redirectet ohnehin)
  const { hasRole } = useRolePermission(me);
  const hasCommunity = ["admin", "superadmin", "moderator"].some(r => hasRole?.(r));
    ...
    return (
      <div className="space-y-6 p-6">
        ...
        <EngagementStats
          ...
          timeseries={[{ t: 1, v: 10 }, { t: 2, v: 12 }, { t: 3, v: 9 }, { t: 4, v: 15 }, { t: 5, v: 14 }, { t: 6, v: 18 }, { t: 7, v: 17 }]}
          segments={[{ label: "NGO A", value: 420 }, { label: "NGO B", value: 315 }, { label: "NGO C", value: 210 }, { label: "Presse", value: 150 }]}
        />
      </div>
    );
  }
