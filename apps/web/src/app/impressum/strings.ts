...
const STRINGS: {
  ...
  responsibleBody: {
    de: [
      ...
      "",
      "Hinweis zum Status",
      "VoiceOpenGov wird aktuell ohne eigene Gesellschaft oder sonstigen separaten Rechtsträger von Ricky G. Fleischer als natürlicher Person betrieben.",
      "Eine VOG Holding, eDebatte.org GmbH oder andere künftig geplante Gesellschaft ist derzeit nicht Anbieter, Vertragspartner oder Zahlungsempfänger.",
    ...
    en: [
      ...
      "",
      "Status note",
      "VoiceOpenGov is currently operated without its own company or other separate legal entity by Ricky G. Fleischer as a natural person.",
      "No VOG Holding, eDebatte.org GmbH or other planned future company is currently the provider, contractual partner or payment recipient.",
  ...
  disclaimerBody: {
    de: [
      ...
      "",
      "Mitgliedschaft und freiwillige Unterstützung",
      "Die Mitgliedschaft bei VoiceOpenGov ist derzeit kostenfrei.",
      "Freiwillige finanzielle Unterstützung ist von der Mitgliedschaft getrennt und verleiht keine zusätzlichen Stimm-, Beteiligungs- oder Zugangsrechte.",
      "Vertragspartner und Zahlungsempfänger für derzeit über VoiceOpenGov abgewickelte Zahlungen ist bis zur wirksamen Umstellung auf einen separaten Rechtsträger Ricky G. Fleischer als natürliche Person.",
      "Derzeit werden keine Spendenquittungen oder Zuwendungsbestätigungen ausgestellt; die Unterstützung wird nicht als steuerbegünstigte Spende angeboten.",
      "",
    ...
    en: [
      ...
      "Voluntary financial support is separate from membership and does not grant additional voting, participation or access rights.",
      "Until an effective transition to a separate legal entity, Ricky G. Fleischer as a natural person is the contractual partner and payment recipient for payments currently processed through VoiceOpenGov.",
      "No donation receipts or charitable contribution certificates are currently issued; support is not offered as a tax-privileged charitable donation.",
      "",
