        ...
        children={[
          ...
          <div key="beiträge">
            ...
            <ContributionList
              ngoView
              user={user}
              onEdit={c => { setEditContribution(c); setShowContributionForm(true); }}
            />
            {showContributionForm && (
              <ContributionForm
                contribution={editContribution}
                onSave={() => { setShowContributionForm(false); setEditContribution(null); }}
                onCancel={() => { setShowContributionForm(false); setEditContribution(null); }}
                user={user}
              />
            )}
          </div>,
          ...
          <div key="statements">
            ...
            <StatementList
              ngoView
              user={user}
              onEdit={s => { setEditStatement(s); setShowStatementForm(true); }}
            />
            {showStatementForm && (
              <StatementForm
          ...
          <div key="stats" className="mt-8">
            {user?.premium ? (
              ...
              <div className="text-gray-400 text-sm text-center mt-10">
                ...
                <p>
                  Auswertung und Analytics stehen nur Premium-Accounts zur Verfügung.<br />
