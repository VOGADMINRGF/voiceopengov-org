...
export type Region = { id: Id; code: string; name: string; scope: "communal"|"regional"|"national"|"eu"|"g7"|"nato"|"global" };
export type Statement = { id: Id; title: string; text: string; lang: string; };
export type Report = { id: Id; title: string; summary?: string };
export type Vote = { id: Id; value: "agree"|"reject"|"neutral"; userId: Id; statementId: Id; ts: string };
